...
export default function Guide() {
  return (
    <div className="flex flex-col items-center mt-11">
      {/* w-36 h-7 */}
        <div className="text-base font-medium uppercase py-2 px-4 bg-gradient-to-r from-[#1EE0E1] to-[rgba(24, 254, 255, 0.00)] rounded-[36px] mb-4 sm:mb-6">UNIQUE FILES</div>
        ...
        <div className="flex flex-col flex-wrap lg:flex-row lg:justify-center lg:gap-x-20 2xl:gap-x-8 lg:gap-y-20 items-center gap-y-14">
